...
import com.automationrhapsody.reststub.resources.ExFoosResource;
...
import com.automationrhapsody.reststub.resources.MyResource;
...
//        
        final ExFoosResource bookServ = new ExFoosResource();
        env.jersey().register(bookServ);
        
        final MyResource bookS = new MyResource();
        env.jersey().register(bookS);
